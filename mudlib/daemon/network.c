...
#define DARKECHATS ({ "land.of.the.chosen", "darkemud", "darkemudtest", "darkprophecy", "dark.prophecy", "darkedomain"})
#define DARKELIBS ({ "land.of.the.chosen", "darkemud", "darkemudtest", "darkprophecy", "dark.prophecy", "darkedomain"})
